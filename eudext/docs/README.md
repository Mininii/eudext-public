...
## spec — 구현 전 명세 (2026-09-17)

`spec\S1_gcb.md`(G_CB 스포너), `S2_pool.md`(건물 스택·TStruct), `S3_display.md`(DisplayPrint), `S4_bullet.md`(사용자판 총알), `S5_dat_bgm.md`(dat 패치·BGM), `S6_chat.md`(채팅 효과·관전자 채팅), `S7_strdesign.md`(StrDesign), `S8_subtract.md` + `S8_ingame\`(뺄셈 의미·인게임 시험), `WP0_report_0.81.md`(euddraft 0.11 재측정). 설계도 각 절이 이 명세를 정본으로 가리킨다.
