...
def build_cases(s):
    ...
    err("rot3d_num", lambda: SA.push(1, SH1, rot3d=7), "rot3d")
    err("rot3d_missing", lambda: SA.push(1, SH1, rot3d=2), "묶음 2 번이 없습니다")
    ...
    err("bounds_word", lambda: SA.push(1, SH1, bounds="wrap"), "bounds")
...
def python_checks(ck):
    ...
    ck.raises("rtype 번호 −1", E, t.rtype, "D", id=-1)  # 0 은 쓸 수 있다 (t_spawn_p6c)
